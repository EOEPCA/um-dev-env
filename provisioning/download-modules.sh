...
LIBRARIES="um-common-oidc-client um-common-uma-client um-common-scim-client endpoint-lookup" 
SERVICES="um-pep-engine um-login-engine um-login-gluu-oxauth um-login-persistence um-user-profile"
